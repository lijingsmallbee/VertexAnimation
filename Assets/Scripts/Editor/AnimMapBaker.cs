...
public struct BakedData
{
    ...
    public Vector3[] animData;
    public int animMapWidth;
    public int animMapHeight;

    #endregion

    public BakedData(string name, float animLen, int width,int height, Vector3[] animData)
    {
        this.name = name;
        this.animLen = animLen;
        this.animMapHeight = height;
        this.animMapWidth = width;
